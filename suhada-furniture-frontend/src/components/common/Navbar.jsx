        ...
        <div className="flex justify-between items-center h-24">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Premium Furniture</p>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-10">
            ...
            <NavLink to="/products" scrolled={scrolled}>Products</NavLink>
            <NavLink to="/categories" scrolled={scrolled}>Categories</NavLink>
